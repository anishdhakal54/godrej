                ...
                <div class="col-lg-6 col-md-6 col-sm-4 col-12">
                    <div class="social-link-2">
                        <ul>
                            ...
                            <li class="vimeo">
                                <a href="https://vimeo.com/" data-toggle="tooltip" target="_blank"
                                   data-original-title="Vimeo">
                                    <i class="lastudioicon-b-vimeo"></i>
                                </a>
                            </li>
                            <li class="youtube">
                                <a href="https://youtube.com/" data-toggle="tooltip" target="_blank"
                        ...
                        <div class="product-summery position-relative">
                            ...
                            <div class="social-link with-radius-2">
                                <ul>
                                    ...
                                    <li class="vimeo">
                                        <a href="https://vimeo.com/" data-toggle="tooltip" target="_blank" title=""
                                           data-original-title="Vimeo">
                                            <i class="lastudioicon-b-vimeo"></i>
                                        </a>
                                    </li>
