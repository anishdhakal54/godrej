...
class ProductEnquiryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend.product-enquiries.index');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $data = [
            ...
            'link' => trans('app.url') . '/my-account/enquiries',
        ...
        Mail::send('emails.enquiry-updated', $data, function ($message) {
            $message->to('basantadahal230@gmail.com', trans('app.url'))->subject('Order Received');
            $message->from(getConfiguration('order_email'), trans('app.name'));
        });
