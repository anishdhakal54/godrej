...
{{--                        <a href="{{ route('dashboard.users.index', 'role=' . 'shop-manager') }}"><i--}}
{{--                                    class="fa fa-table"></i>Shop-Manager</a>--}}
{{--                    </li>--}}
...
{{--                    </li>--}}
{{--                    <li class="{{ request()->has('role') && request('role') === 'client' ? 'active': null }}">--}}
{{--                        <a href="{{ route('dashboard.users.index', 'role=' . 'non-active') }}"><i--}}
{{--                                    class="fa fa-table"></i>Not-Active</a>--}}
{{--                    </li>--}}
...
{{--            <li class="{{ $route == 'dashboard.getquotes' ? 'active': null }}">--}}
{{--                <a href="{{ route('dashboard.getquotes') }}">--}}
{{--                    <i class="fa fa-cogs"></i>--}}
