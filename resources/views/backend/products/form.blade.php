              ...
              <div class="col-md-12">
                <table class="table table-bordered table-size_name">
                  ...
                  <tr>
                    ...
                    <div class="col-md-6">
                      <td><input type="number" name="quantity" value="{{ isset($product) ? $product->quantity
                    : 0}}" class="form-control" placeholder="quantity"></td>
                    </div>

                    <div class="col-md-6">
                      <td><input type="number" name="stock_qty" value="{{ isset($product) ? $product->stock_qty
                    : 0}}" class="form-control" placeholder="Minimum stock"></td>
                    </div>
    ...
    <div class="box-body">
      ...
      <div class="form-group @if ($errors->has('view_chart')) has-error @endif">
        ...
        @if(isset($product) && null !== $product->view_chart)
          <div class="mt-15">
            <img src="{{asset("/view_chart/$product->view_chart")}}"
