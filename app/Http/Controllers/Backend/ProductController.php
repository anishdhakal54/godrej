...
use App\Models\ProductDownload as ModelsProductDownload;
use App\Models\ProductFaq as ModelsProductFaq;
use App\Models\ProductImage as ModelsProductImage;
use App\Models\ProductSpecification as ModelsProductSpecification;
...
class ProductController extends Controller
{
    ...
    {
        $collection = ModelsProductImage::where('path', $request->input('path'))->get(['id']);

        ModelsProductImage::destroy($collection->toArray());
    ...
    {
        $faq = ModelsProductFaq::findOrFail($request->input('faq'));
    ...
    {
        $specification = ModelsProductSpecification::findOrFail($request->input('specification'));
    ...
    {
        $color = ModelsProductColor::findOrFail($request->input('color'));
    ...
    {
        $download = ModelsProductDownload::findOrFail($request->input('download'));
    ...
    {
        // Store file
        $path = FacadesStorage::put('public/downloads', $file, 'public');
